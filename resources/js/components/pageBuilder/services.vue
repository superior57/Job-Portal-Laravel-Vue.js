        ...
        <div class="wt-sliderbox">
            ...
            <div class="amt-slot-title">
                <span class="color-settings">
                    <verte v-model="service.sectionColor" menuPosition="left" model="hex">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
                            ...
                            <path v-bind:style="{ fill: service.sectionColor}" d="M35.5,27.5a3.5,3.5,0,1,1-7,0c0-1.41,1.86-4.75,2.86-6.46a.72.72,0,0,1,1.26,0C33.64,22.75,35.5,26.09,35.5,27.5Z"/>
                            <rect v-bind:style="{ fill: service.sectionColor}" y="35" width="40" height="5" rx="2.5"/>
                        </svg>
                    </verte>
                </span>
            </div>
            <div class="wt-location wt-tabsinfo">
                <div class="wt-sliderbox__form">
                    <div class="form-group form-group-half">
                        <input placeholder="Title"  v-model="service.title" :name="'meta[service'+parent_index+'][title]'" type="text" class="form-control">
                    </div> 
                    <div class="form-group form-group-half">
                        <input placeholder="Subtitle"  v-model="service.subtitle" :name="'meta[service'+parent_index+'][subtitle]'" type="text" class="form-control">
                    </div>
...
export default {
    ...
    created: function() {
        ...
        if (this.services[index]) {
            ...
            this.service.sectionColor = this.services[index].sectionColor
        }
