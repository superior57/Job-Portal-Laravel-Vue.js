        ...
        <div class="wt-sliderbox">
            ...
            <div class="amt-slot-title">
                <span class="color-settings">
                    <verte v-model="category.sectionColor" menuPosition="left" model="hex">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
                            ...
                            <rect v-bind:style="{ fill: category.sectionColor}" y="35" width="40" height="5" rx="2.5"/>
                        </svg>
                    </verte>
                </span>
            </div>
            <div class="wt-location wt-tabsinfo">
                <div class="wt-sliderbox__form">
                    <div class="form-group">
                        <input placeholder="Title" v-model="category.title" :name="'meta[cat'+parent_index+'][title]'" type="text" value="" class="form-control">
                    </div> 
                    <div class="form-group">
                        <input placeholder="Subtitle" v-model="category.subtitle" :name="'meta[cat'+parent_index+'][subtitle]'" type="text" value="" class="form-control">
                    </div>
                    <div class="form-group">
                        <tinymce-editor 
...
export default {
    ...
    props:['parent_index', 'element_id', 'categories'],
    data() {
        return {
            category:{},
        }
    ...
    created: function() {
        ...
        if (this.categories[index]) {
            ...
            this.category.sectionColor = this.categories[index].sectionColor
        }
