        ...
        <div class="wt-sliderbox">
            ...
            <div class="amt-slot-title">
                <span class="color-settings">
                    <verte v-model="freelancer.sectionColor" menuPosition="left" model="hex">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
                            ...
                            <rect v-bind:style="{ fill: freelancer.sectionColor}" y="35" width="40" height="5" rx="2.5"/>
                        </svg>
                    </verte>
                </span>
            </div>
            <div class="wt-location wt-tabsinfo">
                <div class="wt-sliderbox__form">
                    <div class="form-group form-group-half">
                        <input placeholder="Title" v-model="freelancer.title" :name="'meta[freelancer'+parent_index+'][title]'" type="text" class="form-control">
                    </div> 
                    <div class="form-group form-group-half">
                        <input placeholder="Subtitle" v-model="freelancer.subtitle" :name="'meta[freelancer'+parent_index+'][subtitle]'" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <tinymce-editor 
                            v-model="freelancer.description" 
...
export default {
    ...
    props:['parent_index', 'element_id', 'freelancers'],
    data() {
        return {
            freelancer: {}
        }
    ...
    created: function() {
        ...
        if (this.freelancers[index]) {
            ...
            this.freelancer.sectionColor = this.freelancers[index].sectionColor
        }
